﻿function setWceEditor(_id, rtl, finishCallback, de) {
	...
	tinyMCE.init({
		...
		// Theme options
		theme_advanced_buttons1 : "undo,redo,charmap,|,code,removeformat,|,save,print,contextmenu,cut,copy,paste,fullscreen,|,breaks,correction,illegible,decoration,abbreviation,paratext,note,punctuation,|,versemodify,showTeiByHtml,showHtmlByTei,|,english,german",
